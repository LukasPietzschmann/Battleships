...
public class EndWindow {
    ...
    EndWindow(int result, JFrame frame, GameWindow gw){
        ...
        switch (result) {
            case (WIN):
                icon = new ImageIcon(new ImageIcon(ClassLoader.getSystemClassLoader().getResource("win.png")).getImage().getScaledInstance(180, 180, Image.SCALE_SMOOTH));
                message.setText("<html>Glückwunsch! <p/>Du hast gewonnen!</html>");
                break;
            case (LOSE):
                icon = new ImageIcon(new ImageIcon(ClassLoader.getSystemClassLoader().getResource("lose.png")).getImage().getScaledInstance(190, 180, Image.SCALE_SMOOTH));
    ...
    public void setUpMainWindow(){
        ...
        ImageIcon menu = new ImageIcon(new ImageIcon(ClassLoader.getSystemClassLoader().getResource("hauptmenue.png")).getImage().getScaledInstance(160, 60, Image.SCALE_SMOOTH));
