...
public class JGameCanvas extends JPanel implements GameListener, MakeMoveListener, GameEndsListener {
	...
	public void loadTileSet() {
		...
		switch(theme) {
			case "Battleships":
				ImageIcon tilesetIcon = new ImageIcon(new ImageIcon(ClassLoader.getSystemClassLoader().getResource("tileset_battleships.png")).getImage());
				tileset = tilesetIcon.getImage();
				break;
			case "Battlecars":
				tilesetIcon = new ImageIcon(new ImageIcon(ClassLoader.getSystemClassLoader().getResource("tileset_battlecars.png")).getImage());
				tileset = tilesetIcon.getImage();
				break;
		}
	}
