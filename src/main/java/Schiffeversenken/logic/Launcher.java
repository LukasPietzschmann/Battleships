...
import Schiffeversenken.gui.MainWindow;
...
public class Launcher {
	...
	/**
	 * Die {@link AI} gegen einen Gegner übers {@link Schiffeversenken.network.Network}, wobei man selbst der Client ist.
	 */
	public static final int NW_CL_AI = 1;
	/**
	 * Die {@link AI} gegen einen Gegner übers {@link Schiffeversenken.network.Network}, wobei man selbst der Server ist.
	 */
	...
	/**
	 * Ein {@link Human} gegen einen Gegner übers {@link Schiffeversenken.network.Network}, wobei man selbst der Client ist.
	 */
	public static final int PL_NW_CL = 4;
	/**
	 * Ein {@link Human} gegen einen Gegner übers {@link Schiffeversenken.network.Network}, wobei man selbst der Server ist.
	 */
